...
const Platforms = () => {
  return (
    <div className="relative pt-12 border-t border-slate-200 dark:border-pink-950/30">
      ...
      />
      <div className="grid grid-flow-col grid-rows-4 lg:flex lg:items-center justify-center gap-4">
          ...
          return (
            <div
              ...
              className={`rounded-2xl border transition-all duration-300 ${
                platform.isMain
                  ? "w-25 h-25 sm:w-28 sm:h-28 dark:bg-[#1c0514] bg-white border-pink-500/60 shadow-xl shadow-pink-950/50 p-3 scale-105 row-span-3 row-start-2"
